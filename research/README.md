...
13. `10_prod_schema_mapping.md` - what this research fills in the production agency-intelligence tables, what it cannot, and what the attempt found out about the design
