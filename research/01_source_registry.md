...
| Agency intent | DoD Comptroller budget materials | spreadsheet | verified | p1_display.xlsx: 1,138 rows; 55 OPN BA2 lines incl. 2915 CANES 439,977 / 534,324 / 493,046 ($K); r1_display.xl (browserbase, 2026-09-16) | annual |
...
| Congressional decisions | govinfo API (committee reports, explanatory statements, enacted laws, bills) | api | verified | H. Rept. 119-715 (DoD Appropriations Act, 2027) HTML text; OPN table rows read as line, title, request, recomm (direct, 2026-09-17) | daily poll of new CRPT/CREC/PLAW packages matching defense keywords |
...
| Active acquisition | PIEE Solicitation Module (replaced NAVWAR eCommerce) | manual | restricted | official access-instructions PDF (TLS chain is DoD PKI; fetched with verification off and recorded); SAM.gov a (direct, 2026-09-16) | not automated; rely on SAM synopses and record the gap |
...
| Active acquisition | SAM.gov Contract Opportunities archived yearly extracts (FYxxxx_archived_opportunities.csv) | export | verified | FY2025 file: 1,159,352,018 bytes, 399,820 rows, 666 NAVWAR-family notices (posted 2024-10 to 2025-09); gave fi (direct, 2026-09-17) | quarterly re-pull of the two most recent fiscal years |
...
| Organization and ownership | PEO Digital official site (peodigital.navy.mil) | webpage | verified | 'IMPORTANT NOTICE: On May 11, 2026 ... PEO Digital is now part of the PAE Mission Systems' (browserbase, 2026-09-16) | weekly hash diff |
| Organization and ownership | DON CIO CHIPS magazine (official DoN IT publication) | webpage | verified | 'On May 13, 2020, the Deputy Assistant Secretary of the Navy for Information Warfare and Enterprise ... disest (browserbase, 2026-09-16) | monthly |
| Organization and ownership | PAE Mission Systems official site (missionsystems.navy.mil; also served at peoc4i.navy.mil) | webpage | verified | Industry page: five capability portfolios and the Learn / Introduce / Propose intake process (browserbase, 2026-09-16) | weekly hash diff; alert when About, Leadership or a portfolio page app |
| Organization and ownership | PEO MLB official site (peomlb.navy.mil) | webpage | verified | 'PEO MLB is now part of the PAE Mission Systems'; navigation: About, Portfolio, Industry Engagement, Strategic (browserbase, 2026-09-16) | weekly hash diff |
...
| Geographic block (HTTP 403 to any client from a non-US address; confirmed with Cloudflare WARP on and off) | navwar, peoc4i, navsea, navair, niwc, navy.mil, war.gov, comptroller, gao.gov, peodigital | Wayback captures for history; Browserbase (US egress) for live pages and files, tested 2026-09-16 |
| Firewall resets | secnav.navy.mil (budget library, OSBP) | one direct fetch of the FY2027 page and two book downloads succeeded; Wayback and Browserbase are refused; the Comptroller's P-1/R-1 tables cover the line amounts, the DoN exhibit narratives stay queued |
