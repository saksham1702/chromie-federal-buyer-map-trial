...
Compared with `lrae_navwar_2023-06` (key: title+office): 59 records matched (250 field changes on 59 of them), 790 added, 672 removed, 1 keys matching several rows. Detail in `diff_lrae_navwar_2023-06_lrae_navwar_2024-06.csv`. Every release is kept as its own package.
